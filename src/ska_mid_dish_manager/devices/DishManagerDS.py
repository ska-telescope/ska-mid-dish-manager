...
class DishManager(SKAController):
    ...
    @time_tango_write("lastCommandedMode", warn_threshold=1)
    @requires_component_manager
    ...
    @time_tango_write("attenuation1PolHX", warn_threshold=1)
    ...
    @time_tango_write("attenuation1PolVY", warn_threshold=1)
    ...
    @time_tango_write("attenuation2PolVY", warn_threshold=1)
    ...
    @time_tango_write("attenuation2PolHX", warn_threshold=1)
    ...
    @time_tango_write("attenuationPolVY", warn_threshold=1)
    ...
    @time_tango_write("band0PointingModelParams", warn_threshold=1)
    ...
    @time_tango_write("band1PointingModelParams", warn_threshold=1)
    ...
    @time_tango_write("band2PointingModelParams", warn_threshold=1)
    ...
    @time_tango_write("band3PointingModelParams", warn_threshold=1)
    ...
    @time_tango_write("band4PointingModelParams", warn_threshold=1)
    ...
    @time_tango_write("band5aPointingModelParams", warn_threshold=1)
    ...
    @time_tango_write("band5bPointingModelParams", warn_threshold=1)
    ...
    @time_tango_write("band1SamplerFrequency", warn_threshold=1)
    ...
    @time_tango_write("band2SamplerFrequency", warn_threshold=1)
    ...
    @time_tango_write("band3SamplerFrequency", warn_threshold=1)
    ...
    @time_tango_write("band4SamplerFrequency", warn_threshold=1)
    ...
    @time_tango_write("band5aSamplerFrequency", warn_threshold=1)
    ...
    @time_tango_write("band5bSamplerFrequency", warn_threshold=1)
    ...
    @time_tango_write("configureTargetLock", warn_threshold=1)
    ...
    @time_tango_write("dshMaxShortTermPower", warn_threshold=1)
    ...
    @time_tango_write("dshPowerCurtailment", warn_threshold=1)
    ...
    @time_tango_write("noiseDiodeConfig", warn_threshold=1)
    ...
    @time_tango_write("programTrackTable", warn_threshold=1)
    ...
    @polyTrack.write
    @time_tango_write("polyTrack", warn_threshold=1)
    ...
    @time_tango_write("trackInterpolationMod", warn_threshold=1)
    ...
    @time_tango_write("trackProgramMode", warn_threshold=1)
    ...
    @time_tango_write("trackTableLoadMode", warn_threshold=1)
    ...
    @scanID.write
    @time_tango_write("scanID", warn_threshold=1)
    ...
    @ignoreSpf.write
    @time_tango_write("ignoreSpf", warn_threshold=1)
    ...
    @ignoreSpfrx.write
    @time_tango_write("ignoreSpfrx", warn_threshold=1)
    ...
    @time_tango_write("noiseDiodeMode", warn_threshold=1)
    ...
    @time_tango_write("periodicNoiseDiodeModePars", warn_threshold=1)
    ...
    @time_tango_write("pseudoRandomNoiseDiodePars", warn_threshold=1)
    ...
    @time_tango_write("spectralInversion", warn_threshold=1)
    ...
    @time_tango_write("dscPowerLimitKw", warn_threshold=1)
    ...
    @time_tango_write("watchdogTimeout", warn_threshold=1)
    @requires_component_manager
    ...
    @time_tango_write("autoWindStowEnabled", warn_threshold=1)
    ...
    @time_tango_write("actionTimeoutSeconds", warn_threshold=1)
    ...
    @time_tango_write("b1LnaHPowerState", warn_threshold=1)
    ...
    @time_tango_write("b2LnaHPowerState", warn_threshold=1)
    ...
    @time_tango_write("b3LnaHPowerState", warn_threshold=1)
    ...
    @time_tango_write("b4LnaHPowerState", warn_threshold=1)
    ...
    @time_tango_write("b5aLnaHPowerState", warn_threshold=1)
    ...
    @time_tango_write("b5bLnaHPowerState", warn_threshold=1)

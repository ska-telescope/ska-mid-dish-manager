...
class SPFDevice(Device):
    ...
    def init_device(self):
        ...
        self._b1_capability_state = SPFCapabilityStates.STANDBY
        self._b2_capability_state = SPFCapabilityStates.STANDBY
        self._b3_capability_state = SPFCapabilityStates.STANDBY
        self._b4_capability_state = SPFCapabilityStates.STANDBY
        self._b5_capability_state = SPFCapabilityStates.STANDBY

...
class TangoDeviceComponentManager(BaseComponentManager):
    ...
    def update_state_from_monitored_attributes(
        ...
        # TODO because it only checks that configuredBand is B[x] but dishMode is also needed
        # TODO cross checks all the other commands or just wait for feature branch with new S&M

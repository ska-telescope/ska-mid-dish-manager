...
FROM registry.gitlab.com/ska-telescope/ska-base-images/ska-build-python-ubuntu26:6d8cef89 as build
...
FROM registry.gitlab.com/ska-telescope/ska-base-images/ska-python-ubuntu26:6d8cef89
WORKDIR /app

...
def test_last_command_failure(
    ...
    dm_last_command_failure_value_1 = dish_manager_proxy.read_attribute("lastCommandFailure").value  # ty: ignore[unresolved-attribute]

    # Happy Path: Run a command that passes - expect no update on DM

    dish_manager_proxy.SetKValue(5)
    dm_last_command_failure_value_2 = dish_manager_proxy.read_attribute("lastCommandFailure").value  # ty: ignore[unresolved-attribute]
    ...
    dm_last_command_failure_value_3 = dish_manager_proxy.read_attribute("lastCommandFailure").value  # ty: ignore[unresolved-attribute]

...
def test_start_stop_communication(
    ...
    # Change the DishMode to LP - to see if it will work now that start_comm was called and the
    ...
    # Check that the component state reports the Standby LP - indicating that the device can now
    # receive commands.

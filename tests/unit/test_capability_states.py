...
def test_capability_state_rule_unavailable(dish_mode_model):
    ...
    spf_component_state = {}
    spf_component_state["capabilitystate"] = SPFCapabilityStates.UNAVAILABLE
...
def test_capability_state_rule_standby(dish_mode_model):
    ...
    ds_component_state["indexerposition"] = None
    spf_component_state = {}
    spf_component_state["capabilitystate"] = SPFCapabilityStates.STANDBY
    spfrx_component_state = {}
    spfrx_component_state["capabilitystate"] = SPFRxCapabilityStates.STANDBY
    dish_manager_component_state = {}
...
def test_capability_state_rule_degraded(dish_mode_model):
    ...
    spf_component_state["capabilitystate"] = SPFCapabilityStates.STANDBY
    spfrx_component_state = {}
    spfrx_component_state["capabilitystate"] = SPFRxCapabilityStates.OPERATE
    dish_manager_component_state = {}
...
def test_capability_state_rule_operate(dish_mode_model):
    ...
    ds_component_state["operatingmode"] = None
    spf_component_state = {}
    spf_component_state["capabilitystate"] = SPFCapabilityStates.OPERATE_FULL
    spfrx_component_state = {}
    spfrx_component_state["capabilitystate"] = SPFRxCapabilityStates.OPERATE
    dish_manager_component_state = {}
    dish_manager_component_state["dishmode"] = DishMode.STOW
...
def test_capability_state_rule_unknown(dish_mode_model):
    ...
    ds_component_state["indexerposition"] = None
    spf_component_state = {}
    spf_component_state["capabilitystate"] = None
    spfrx_component_state = {}
    spfrx_component_state["capabilitystate"] = None
    dish_manager_component_state = {}

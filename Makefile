...
PYTHON_SWITCHES_FOR_BLACK ?= --line-length 99 ## Override the custom switches added to black to increase the line length

PYTHON_SWITCHES_FOR_ISORT ?= -w 99 ## Override the custom switches added to isort to increase the line length

PYTHON_SWITCHES_FOR_FLAKE8 ?= --max-line-length=99 ## Override the default max line length (=79) for flake8
